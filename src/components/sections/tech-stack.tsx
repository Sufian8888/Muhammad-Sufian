...
export default function TechStack() {
  return (
    <section id="tech-stack" className="py-20 px-4 relative overflow-hidden border-t border-b border-gray-200 dark:border-gray-800">
          ...
          {technologies.map((tech, index) => (
            ...
            >
              <div className="relative z-10 flex flex-col">
                ...
                <p className="text-gray-600 dark:text-gray-400">{tech.category}</p>
              </div>
            </motion.div>
          ))}
        </div>
